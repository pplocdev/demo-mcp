...
from utils import  convert_mcp_tools_to_gemini
...
class MCPClient:
    ...
    async def process_query(self, query: str) -> str:
        ...
        contents = [
            types.Content(
                role="model", parts=[types.Part(text="You are a helpful assistant at the store")]
            )
        ]
        ...
        response = self.genai_client.models.generate_content(
            model='gemini-2.0-flash-lite-001',  # Specifies which Gemini model to use
            contents=contents,  # Send user input to Gemini
